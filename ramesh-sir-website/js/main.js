(function () {
    ...
    // ----- Header scroll (optional: add shadow/background on scroll) -----
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
            ...
            // Simulate send (replace with real endpoint or mailto if needed)
            console.log('Form submit:', { name: name, email: email, phone: phone, message: message });
            alert('Thank you! Your message has been sent. We will get back to you soon.');
            contactForm.reset();
        });
    }

    // ----- Optional: highlight nav link for current section -----
